...
class Type6(Enum):
    WaterQualityPredicted = 'WaterQualityPredicted'


class WaterQualityPredictionValue(Enum):
    Excellent = 'Excellent'
    Good = 'Good'
...
class WaterQualityPredicted(BaseModel):
    ...
    datePredicted: Optional[str] = Field(
        None,
    ...
    predictions: Optional[Predictions] = Field(
        None, description='List of predictions for water quality'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be WaterQualityPredicted'
    )
    waterQualityPredictionValue: Optional[WaterQualityPredictionValue] = Field(
        None, description='Describes a summary of the water quality prediction'
    )
