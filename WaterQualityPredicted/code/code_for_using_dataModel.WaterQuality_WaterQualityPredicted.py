...
predictions = {'value': [{'percentile': '2.5', 'prediction': 0.3}, {'percentile': '50', 'prediction': 0.3}, {'percentile': '90', 'prediction': 0.3}, {'percentile': '95', 'prediction': 0.3}, {'percentile': '97.5', 'prediction': 0.3}]}
...
attribute = "waterQualityPredictionValue"
value = waterQualityPredictionValue
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
